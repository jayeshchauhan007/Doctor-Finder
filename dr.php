...
<body>
	    ...
	    <article>
				<?PHP
                  $query="SELECT patient.name as name,patient.surname as surname,patient.email as email,appointment.date as date,appointment.info as info,appointment.payment as payment,appointment.appoint_id as app_id FROM appointment,patient where patient.patient_id=appointment.patient_id and appointment.doctor_id='$staffno'";
                  $result=mysqli_query($conn,$query);
                  $rows=mysqli_num_rows($result);
                  ...
                  ?>
                    ...
                    <th><p style="color: white;"><a class="button button-reversed" href="cancel.php?edt=<?php echo $rows['app_id'];?>" >Remove</a></p></th>
                   </tr>
                     <?php
