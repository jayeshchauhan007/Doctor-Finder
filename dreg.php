...
<body>
				...
				<ul>
                	<li>
                        ...
                        <ul class="blocklist">
                            ...
                            <li><a href="dlogin.php">Doctor Log In</a></li>
                            <li ><a href="register.php">Patient</a></li>
                            <li class="selected-item"><a href="dreg.php">Doctor</a></li>
	    ...
	    <article>
				<?php
                              $name=$surname=$dob=$doctor_type=$other=$email=$cellno=$pwd=$cpwd=$hashp="";
                         
                              $ername=$ersurname=$erdoctor_type=$erother=$erdob=$eremail=$ercellno=$erpwd=$ercpwd="";
                              $Tname=$Tsurname=$Tdoctor_type=$Tother=$Tdob=$Temail=$Tcellno=$Tpwd=$Tcpwd=false;
                              ...
                              if (empty($_POST["name"])) {
                               ...
                               if (empty($_POST["doctor_type"])) {
                                $erdoctor_type = "doctor is required";
                                $Tdoctor_type=false;
                              } else {
                                $doctor_type = test_input($_POST["doctor_type"]);
                                $Tdoctor_type=true;
                                // check if name only contains letters and whitespace
                             ...
                             if (empty($_POST["cpwd"])) {
                               ...
                               if ($Tname&&$Tsurname&&$Temail&&$Tcellno&&$Tdoctor_type&&$Tpwd&&$Tcpwd&&$hashp) {
                                          
                                                    //echo $staffno." ".;
                                         
                                                  $sql="insert into doctor (name,surname,doctor_type,email,cellno,password)
                                                   values ('$name','$surname','$doctor_type','$email','$cellno','$hashp')";
        ...
        ?>
				...
				<fieldset>
                    ...
                    <p><label for="email">Doctor Type:</label>
                      <input name="doctor_type" id="doctor_type" value="<?php echo $doctor_type;?>" type="text" /> <span class="error"><?php echo $erdoctor_type;?></span> </p>
